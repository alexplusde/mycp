...
Quelle: https://redaxo.org/doku/main/addon-assets
...
Beim Styling muss also beachtet werden, dass jeder Selektor zweimal angesprochen wird. Mit nativem CSS ist das leider etwas aufwendiger als beispielsweise mit Sass, bei dem *mixins* verwendet werden können.
...
``n
                            ...
                            [**Artikel bearbeiten](https://github.com/redaxo/docs/edit/main/addon-assets.md)
