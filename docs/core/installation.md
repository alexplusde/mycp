...
Quelle: https://redaxo.org/doku/main/installation
...
Die Systemanforderungen zum aktuellen Release und vorheriger Releases sind unter [https://redaxo.org/download/core/](https://redaxo.org/download/core/) einsehbar. 
...
- Die neueste Version unter [https://redaxo.org/download/core/](https://redaxo.org/download/core/) herunterladen.

- Die ZIP-Datei auf dem eigenen Rechner entpacken.

- Die entpackten Dateien in das Webverzeichnis hochladen und die Installation unter der Adresse der Website mit angehängtem /redaxo/ ([http://deinedomain.tld/redaxo/](http://deinedomain.tld/redaxo/)) ausführen.

- Alle [Installationsschritte](#install) durchgehen.

### Download

Als Erstes die aktuelle Version von REDAXO unter [https://redaxo.org/download/core/](https://redaxo.org/download/core/) herunterladen.
Informationen zum aktuellen Release gibt es unter [https://github.com/redaxo/redaxo/releases](https://github.com/redaxo/redaxo/releases).
...
Nachdem REDAXO hochgeladen wurde, kann die Installation mit [http://deinedomain.tld/redaxo/](http://deinedomain.tld/redaxo/) aufgerufen werden.
...
[Siehe: Konsole](/doku/main/console)
...
**Anleitung bei GitHub:** [REDAXO mit Docker](https://github.com/FriendsOfREDAXO/redaxo-mit-docker)
                [**Artikel bearbeiten](https://github.com/redaxo/docs/edit/main/installation.md)
