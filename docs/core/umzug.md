...
Quelle: https://redaxo.org/doku/main/umzug
...
- Die Datenbank der Quell-Präsenz wird mithilfe des [Backup](/doku/main/backup)-AddOns ***auf dem Server*** gesichert.
...
- Anschließend einloggen und ggf. im Bereich `System` den Cache löschen.
                ...
                [**Artikel bearbeiten](https://github.com/redaxo/docs/edit/main/umzug.md)
