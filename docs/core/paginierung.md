...
Quelle: https://redaxo.org/doku/main/paginierung
...
Eine etwas komplexere Ausgabe steht im Fragment `fragments/core/navigations/pagination.php`. Ein [Beispiel einer kompletten Ausgabe einer Paginierung](/doku/main/fragmente) mit diesem Fragment steht im Kapitel Fragmente.
...
``n
                            ...
                            [**Artikel bearbeiten](https://github.com/redaxo/docs/edit/main/paginierung.md)
