...
Quelle: https://redaxo.org/doku/main/system
...
REDAXO unterstützt mehrere Sprachen. Im Reiter Sprachen können diese angelegt und verwaltet werden. Weitere Informationen zum Thema im Kapitel: [Mehrsprachigkeit](/doku/main/mehrsprachigkeit).
...
Ist das History-PlugIn der Struktur installiert, kann die Historie hier gelöscht werden.
                [**Artikel bearbeiten](https://github.com/redaxo/docs/edit/main/system.md)
