...
Quelle: https://redaxo.org/doku/main/kategorien-artikel
...
Ein Artikel muss ein Template haben. Templates enthalten im Normalfall das HTML-Grundgerüst und werden in einem eigenen Kapitel [Templates ausführlich erläutert](/doku/main/templates).
...
Auch Module werden in in einem eigenen Kapitel [Module ausführlich behandelt](/doku/main/module).
...
Die C-Types werden ebenfalls im Kapitel [Templates dokumentiert](/doku/main/templates).
...
Den Umgang mit Metainformationen behandelt ein eigenes Kapitel [Metainformationen ausführlich](/doku/main/metainformationen).
...
In den Kapiteln [Konfiguration](/doku/main/konfiguration) sowie [Navigationen](/doku/main/navigationen) werden weitergehende Funktionen und Eigenschaften mit Beispielen erklärt. 

                [**Artikel bearbeiten](https://github.com/redaxo/docs/edit/main/kategorien-artikel.md)
