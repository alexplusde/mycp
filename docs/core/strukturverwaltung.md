...
Quelle: https://redaxo.org/doku/main/strukturverwaltung
...
Normale Artikel können in eine Kategorie umgewandelt werden. Dies erfolgt im Funktionsreiter des entsprechenden Artikels.
                [**Artikel bearbeiten](https://github.com/redaxo/docs/edit/main/strukturverwaltung.md)
