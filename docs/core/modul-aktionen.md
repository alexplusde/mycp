...
Quelle: https://redaxo.org/doku/main/modul-aktionen
...
Preview
Wird vor dem Anzeigen des Moduls ausgeführt.

Presave
Wird vor dem Speichern des Moduls ausgeführt.

Postsave
Wird nach dem Speichern des Moduls ausgeführt.
...
``n
                            ...
                            [**Artikel bearbeiten](https://github.com/redaxo/docs/edit/main/modul-aktionen.md)
